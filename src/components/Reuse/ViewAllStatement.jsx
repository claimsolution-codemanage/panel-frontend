  ...
  return (<>
    {loading ? <Loader /> :
      <div>
        ...
        <div className="d-md-flex justify-content-between bg-color-1 text-primary fs-5 px-4 py-3 shadow">
          ...
          <div className="d-flex gap-2">
            ...
            <button onClick={()=>setStatementPreview(true)} className={`btn btn-primary`}>
              Preview
            </button>
          </div>
        ...
        <StatementPdfPreviewModal data={data} statementOf={statementOf} dateRange={dateRange} show={statementPreview} handleClose={() => setStatementPreview(false)} />
