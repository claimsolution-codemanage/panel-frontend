...
// case payment imports
import ClientAllCasePayment from "../features/casePaymentDetails/pages/allCasePayment/client/ClientAllCasePayment"
import ClientViewCasePayment from "../features/casePaymentDetails/pages/allCasePayment/client/ClientPaymentView"
...
export const clientRoutes = [
  ...
  // case payment start
  <Route path='/client/case-payment' element={<ClientTemplate><ClientAllCasePayment /></ClientTemplate>} />,
  <Route path='/client/case-payment/view/:_id' element={<ClientTemplate><ClientViewCasePayment /></ClientTemplate>} />,
  // case payment end
]
