...
export default function SenderModal({ show, onHide, formik, data, handleChange, onSave }) {

  // console.log("sender", formik.errors);
      ...
      >
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Sender Details</h5>
