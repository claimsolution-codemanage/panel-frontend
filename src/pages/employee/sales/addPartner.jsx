...
export default function EmployeeAddPartner() {
    ...
    const UserDetailsFormik = useFormik({
        initialValues: {
            fullName: "", email: "", mobileNo: "",workAssociation: "", areaOfOperation: ""},
        ...
        onSubmit: async (values) => {
            setDisable(true)
            try {
                const res = await salesEmployeeAddPartner(values)
                if (res?.data?.success) {
                    ...
                    <div className="row p-0 m-0">
                        <div className="col-12 p-0  bg-color-7 color-4">
                            <div className="mx-auto px-2 px-md-0 py-5">
                                <div className="h2 fw-bold text-center">Add Partner</div>
