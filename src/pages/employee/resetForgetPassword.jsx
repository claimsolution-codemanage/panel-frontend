...
export default function EmployeeResetForgetPassword() {
    ...
    const handleSumbit = async (e) => {
        ...
        if (param?.verifyToken) {
            try {
                const res = await employeeResetForgetPassword(data, param?.verifyToken)
                if (res?.data?.success) {
                                        ...
                                        <div className="w-75">
                                            ...
                                            <div class="form-check mt-2 pb-5">
                                                <label class="float-end" >
                                                    <Link to="/employee/signin" className=''>Remember your password? signin</Link>
                                                </label>
                                            </div>
                                            <div className="mt-5">
