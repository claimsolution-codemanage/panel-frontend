...
import { partnerImageUpload,employeeImageUpload } from "../../apis/upload";
...
export default function EmployeeEditPartner() {
    ...
    const handleOnsubmit = async(e)=>{
        ...
        setLoading(true)
        try {
            const res = await employeeUpdatePartnerProfile(param?._id,data)
    ...
    const handleBankDetailsOnsubmit = async (e) => {
        ...
        setSaving(true)
        try {
            const res = await employeeUpdatePartnerBankingDetails(param?._id,{...bankDetails,...bankInfoImg})
                ...
                <div>
                    ...
                    <div className="m-0 row p-md-5">
                        ...
                        <div className="mb-3 col-12 col-md-4">
                            ...
                            <input type="number" name="primaryMobileNo" value={data.primaryMobileNo}  onChange={(e)=>checkPhoneNo(e?.target?.value,12) && handleOnchange(e)} className="form-control" id="primaryMobileNo" aria-describedby="primaryMobileNo" />
                        </div>
                     
                     
                        <div className="mb-3 col-12 col-md-4">
                            <label for="alternateMobileNo" className="form-label">Alternative Mobile No</label>
                            <input type="tel" name="alternateMobileNo" value={data.alternateMobileNo} onChange={(e)=>checkPhoneNo(e?.target?.value) && handleOnchange(e)} className="form-control" id="alternateMobileNo" aria-describedby="alternateMobileNo" />
                        </div>
                        <div className="mb-3 col-12 col-md-4">
