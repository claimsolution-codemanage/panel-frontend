...
export default function PartnerMobileSendOtp() {
                            ...
                            <div className="col-sm-12 col-md-6 bg-color-7 color-4 p-0">
                                <div className="p-5">
                                    ...
                                    <div class="form-check">
                                     <label class="float-end" >
                                            <div onClick={()=>{setSendOTP(false);setDisableVerify(false)}} className="text-decoration-underline text-primary" style={{cursor:'pointer'}}>Go Back</div>
                                        </label>
                                    </div>
                                    <div className="mt-5">
                                ...
                                : <div className='aligin-items-center d-flex justify-content-center'>
                                   ...
                                   value={sendMobileNo} disabled={true}/>
                                    ...
                                    <div class="form-check">
                                     <label class="float-end" >
                                            <Link to="/partner/signup" className="text-decoration-underline text-primary">Go Back</Link>
                                        </label>
                                    </div>
                                    </div>
