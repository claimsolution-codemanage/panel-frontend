...
export default function PartnerTemplate({children}){
  ...
  <div className="container-fluid">
            <div className="contanter row" style={{height:'100vh'}}>
                <div className="d-md-none col-12 p-3 bg-color-4 d-flex justify-content-between"><span></span> <span onClick={()=>setView(!view)}>{view ? <RxCrossCircled className="fs-3 text-white"/>:<RxHamburgerMenu className="fs-3 text-white"/>} </span> </div>
